  ...
  try {
    ...
    return(
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <select id="role" name="role" value={formData.role} onChange={handleChange} className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500" required>
            ...
            <label htmlFor="is_scholar" className="block text-sm font-medium text-gray-700">Are you a scholar?</label>
            </div>
            <div className="flex items-center">
                ...
                <label htmlFor="agreement" className="ml-2 block text-sm text-gray-900">I agree to the <a href="#" className="text-blue-600 hover:text-blue-500">Terms and Conditions</a></label>
            </div>
            <div>
